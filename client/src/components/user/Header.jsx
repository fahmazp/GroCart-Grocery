      ...
      <nav className="sticky top-0 z-50 py-1 md:py-2.5 px-2 md:px-8">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex flex-1 items-center justify-end gap-2.5">
            ...
            <Link
              to="/user/cart"
              className="relative inline-flex items-center justify-center size-8 rounded-full bg-green-100 hover:bg-green-200 text-green-800 transition-colors duration-200"
            >
              <ShoppingCartIcon size={20} strokeWidth={2} />
              <span className="absolute -top-1 -right-1 text-[10px] bg-red-500 text-white w-4 h-4 flex items-center justify-center rounded-full font-semibold shadow-md">
                4
              </span>
            </Link>
